...
//     const mapRef = useRef<null | undefined>(null);
//     mapRef.current = map;

//     // initialize map on first render - logic formerly put into componentDidMount
//     useEffect(() => {

//         let viewport:any = document.querySelector('.ol-viewport');
...
//             let initialLocation = fromLonLat(props.location);
...
//             if (marker_el) {
//                 marker_el.addEventListener('mousedown', function (evt:any) {
...
//                 const transormedCoord = transform([lonLat[0], lonLat[1]], 'EPSG:3857', 'EPSG:4326')
...
//                 <p>{(selectedCoord) ? olCoordinate(selectedCoord, 5) : ''}</p>
//             </div>
